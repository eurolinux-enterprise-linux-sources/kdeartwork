...
NextButton::NextButton(NextClient *parent, 
 ...
 * string; see the KWin::KDecoration class, methods
...
bool NextClientFactory::supports( Ability ability ) const
{
    switch( ability )
    {
...
QList< NextClientFactory::BorderSize >
