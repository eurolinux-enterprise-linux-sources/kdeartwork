...
{
	KConfig configFile(QLatin1String( "kwinquartzrc" ));
	...
	onAllDesktopsButtonOnLeft = KDecoration::options()->titleButtonsLeft().contains( QLatin1Char( 'S' ) );
